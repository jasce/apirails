	 ...
	 def create
		 respond_booking = current_store.respond_bookings.build(respond_booking_params)
		   ...
		   if respond_booking.save	
		   		...
		   		respond_booking.update(store_category_id: booking.store_category_id)
		      ...
		      render json: respond_booking,include: :store_category, status: 201#, location: [:api,:v1,:user, booking]
		   else
